#!/usr/bin/env python3
"""
ResNet-18 Targeted Label Noise — multi-seed replication (seeds 137, 256).

Runs 3 key conditions per seed (6 lanes total) sequentially:
...
Usage:
    python runpodScripts/run_resnet18_seed137_label_noise.py
    python runpodScripts/run_resnet18_seed137_label_noise.py --dry-run
"""
import os
import sys
import json
...
# ── Lane definitions (same 3 conditions per seed) ─────────────────────
NOISE_CONDITIONS = {
...
def main():
    parser = argparse.ArgumentParser(
        description="Run targeted label noise replication with seeds 137 & 256",
    )
